...
class ScheduleAdmin(admin.ModelAdmin):
    fieldsets = (
        ...
        (_('Advanced options'), {
            'classes': ('collapse',),
            'fields': ('effective_first_end_dt', 'effective_last_start_dt', 'from_collection', 'source'),
        }),
    )
    readonly_fields = ('effective_first_end_dt', 'effective_last_start_dt', 'source', 'from_collection')
