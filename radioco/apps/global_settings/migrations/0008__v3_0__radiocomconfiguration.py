    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history', models.TextField(default='', help_text='The history of the station', verbose_name='history', blank=True)),
                ...
                ('station_photos', models.TextField(default='', help_text='A list of urls to the station photos', verbose_name='station photos', blank=True)),
