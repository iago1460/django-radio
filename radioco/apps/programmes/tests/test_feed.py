...
<rss xmlns:atom="http://www.w3.org/2005/Atom" xmlns:itunes="http://www.itunes.com/dtds/podcast-1.0.dtd" version="2.0"><channel><title>Morning News</title><link>http://example.com/programmes/morning-news/</link><description>
        ...
        Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,
        when an unknown printer took a galley of type and scrambled it to make a type specimen book.
    </itunes:summary><itunes:image>http://testserver/media/_versions/defaults/example/radio_1_itunes_image.jpg</itunes:image><itunes:category>News &amp; Politics</itunes:category><image url="http://testserver/media/_versions/defaults/example/radio_1_rss_image.jpg" link="/programmes/morning-news/" title="Morning News"></image><item><title>1x1 Episode 1</title><link>http://example.com/programmes/morning-news/1x1/</link><description>
        Lorem Ipsum is simply dummy text of the printing and typesetting industry.
        Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,
        when an unknown printer took a galley of type and scrambled it to make a type specimen book.
